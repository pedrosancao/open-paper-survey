		...
		for ($i = 0; $i < $xdim; $i++) {
			for ($j = 0; $j < $ydim; $j++) { // Scan the entire image
				...
				if (($ar == 1) && (($br >= 2) && ($br <= 6)) && ($p1 == 0) && ($p2 == 0)) {
					...
					imagecolorsettrue($y, $i, $j, 0, $white, $black); //$y[$i][$j] = 0;
				}
			}
		}
...
// Character recognition algorithm from
